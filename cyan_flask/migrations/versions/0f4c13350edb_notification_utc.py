...
def upgrade():
    ...
    for notification in notifications:
    	...
    	utc_unix_time = int(str(unix_time + 14400) + "000")  # NOTE: "000" padding due to notifications endpoint having 3 trailing 0's (see utils.convert_to_timestamp)
...
def downgrade():
    ...
    for notification in notifications:
    	...
    	edt_unix_time = int(str(unix_time - 14400) + "000")  # NOTE: "000" padding due to notifications endpoint having 3 trailing 0's (see utils.convert_to_timestamp)
