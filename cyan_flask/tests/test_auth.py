...
class TestAuth(unittest.TestCase):
    ...
    def test__create_email_message(self, password_handler_mock):
        ...
        password_handler_mock.return_value = test_reset_link
    ...
    def test__create_reset_link(self, encode_auth_token_mock):
        ...
        encode_auth_token_mock.return_value = "somerandomtokenvalue".encode()
    ...
    def test__send_mail_1(self, smtp_mock):
        ...
        actual_result = PasswordHandler()._send_mail(
            smtp_email, smtp_pass, user_email, msg
        )
    ...
    def test_hash_password(self, salt_mock):
        ...
        salt_mock.return_value.hexdigest.return_value.encode.return_value = test_salt
    ...
    def test_send_password_reset_email(
        ...
        _send_mail_mock.return_value = email_response
