...
class TestWebAppApi(unittest.TestCase):
	...
	def test_register_user_2(self, user_query_mock):
		...
		user_query_mock\
			...
			.return_value.first\
			.return_value = example_db_result
	...
	def test_register_user_3(self, user_query_mock):
		...
		user_query_mock\
			.return_value.filter_by\
			.return_value.first\
			.side_effect = [None, example_db_result]
	...
	def test_register_user_4(self, user_query_mock, password_mock, db_mock):
		...
		password_mock\
			.return_value.hash_password\
			.return_value = 'b4e8ced1a488722d8179a7294a2e27ecb07971e0bb24b32f55deeb417702dd5d309a180511a01758489e17ab93693ac0946332d4dd495c5b09421e7d754f1e3ecffd123afa5e009519ff6a543f028387a09c7aa8b4a27da2183b8299cac10f02'

		expected_result = {"status": "success", "username": test_request['user'], "email": test_request['email']}, 200
		actual_result = web_app_api.register_user(test_request)
	...
	@patch('cyan_flask.app.web_app_api.PasswordHandler')
	@patch('flask_sqlalchemy._QueryProperty.__get__')
	def test_login_user_4(self, user_query_mock, password_mock, notifications_mock, settings_mock, db_mock, jwt_mock, user_locations_mock):
		"""
		login_user success.
		"""
		example_db_result = User(
		...
		jwt_mock\
			.return_value.encode_auth_token\
			.return_value = user_data['auth_token']
	...
	@patch('cyan_flask.app.web_app_api.PasswordHandler')
	@patch('flask_sqlalchemy._QueryProperty.__get__')
	def test_login_user_5(self, user_query_mock, password_mock, notifications_mock, settings_mock, db_mock, jwt_mock, user_locations_mock):
		"""
		login_user success.
		"""
		example_db_result = User(
	...
	@patch('cyan_flask.app.web_app_api.PasswordHandler')
	@patch('flask_sqlalchemy._QueryProperty.__get__')
	def test_login_user_6(self, user_query_mock, password_mock, notifications_mock, settings_mock, db_mock, jwt_mock, user_locations_mock):
		"""
		login_user success.
		"""
		example_db_result = User(
	...
	def test_get_user_locations(self, location_query_mock, read_location_row_mock):
		...
		read_location_row_mock\
			.return_value = location_json
	...
	def test_get_notifications_1(self, get_users_notifications_mock, make_notifications_request_mock, parse_notifications_response_mock):
		"""
	...
	@patch('cyan_flask.app.web_app_api.utils.make_notifications_request')
	@patch('cyan_flask.app.web_app_api.get_users_notifications')
	def test_get_notifications_2(self, get_users_notifications_mock, make_notifications_request_mock,
		parse_notifications_response_mock, db_mock, convert_notification_to_list_mock):
		"""
		...
		get_users_notifications_mock\
			.return_value = [example_db_result_list]

		make_notifications_request_mock\
			.return_value = [example_notification]
	...
	def test_parse_notifications_response_1(self):
		...
		expected_result = []
		actual_result = web_app_api.parse_notifications_response(new_notifications, last_visit, user)
	...
	def test_parse_notifications_response_2(self, convert_to_timestamp_mock):
		...
		convert_to_timestamp_mock\
			.return_value = converted_timestamp
	...
	def test_edit_settings_2(self, settings_query_mock, db_mock):
		...
		settings_query_mock\
			.return_value.filter_by\
			.return_value.first\
			.side_effect = [example_db_user, example_db_result]
	...
	def test_reset_password_3(self, user_query_mock, password_mock):
		...
		password_mock\
			.return_value.send_password_reset_email\
			.return_value = error_obj
