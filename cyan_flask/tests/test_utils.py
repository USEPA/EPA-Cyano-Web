...
class TestAuth(unittest.TestCase):
	...
	def test_build_comments_json(self, build_replies_json_mock, build_comment_images_mock):
		"""
		build_comments_json
		"""
		comment_json = {
	...
	def test_save_image_source_1(self, _generate_image_filename_mock, _build_image_file_path_mock):
		"""
		save_image_source
		"""
		username = "test"
		...
		_generate_image_filename_mock\
			.return_value = ""

		_build_image_file_path_mock\
			.return_value = ""
	...
	@patch('cyan_flask.app.utils._build_image_file_path')
	@patch('cyan_flask.app.utils._generate_image_filename')	
	def test_save_image_source_2(self, _generate_image_filename_mock, _build_image_file_path_mock):
		"""
		save_image_source
		"""
		username = "test"
